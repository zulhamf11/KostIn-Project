                        ...
                        <div class="col-xl-9 col-lg-9 col-md-12 no-padding">
                            <div class="akun-layer">
                                ...
                                <div class="layer-form">
                                    <form action="{{ route('kostOwner/storeEditKost') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="kostID" value="{{ $kost->id }}" />
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                                <label for="form-nama">Nama Kos</label>
                                                <input type="text" placeholder="{{ $kost->name }}" id="form-nama" name="kostName">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                                ...
                                                <input type="number" placeholder="{{ $kostDetail->jumlahKamar }}" id="form-nama" name="kostJumlahKamar" min="1" required>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                                ...
                                                <input type="number" placeholder="{{ $kostDetail->jumlahPenghuni }}" id="form-nama" name="kostJumlahPenghuni" required>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 no-padding">
                                                ...
                                                <input type="number" placeholder="Rp. {{ $kostDetail->harga }}" id="form-harga" name="kostPrice" required> 
                                            ...
                                            <div class="col-xl-12 col-lg-12 no-padding">
                                                ...
                                                <textarea name="kostDescription" id="form-detail-kos" placeholder="{{ $kost->description }}" required></textarea>
